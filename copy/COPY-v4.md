...
| `pov.card.06` | Audience narrative(s) | Adjacent industries, regulators, acquirers - each needs their own story. |
...
| `two-kinds.closing` | Body (centered below table) | You need someone to build the early GTM architecture and then show up ready. |
...
| LOCATION | Type | Copy |
|----------|------|------|
| `work.additional.heading` | Eyebrow | Prior [related experience](https://portfolio.jeremyafinch.com/) |
