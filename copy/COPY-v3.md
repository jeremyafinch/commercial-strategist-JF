...
| `two-kinds.table.foundational` | Table cell | The first is **foundational**. Why should this company exist? Who is the user, the buyer, and the economic customer? What are you displacing, and what will a rational buyer need to say yes? These are the initial load-bearing elements of your commercial architecture. |
| `two-kinds.table.episodic` | Table cell | The second is **episodic** - triggered by specific moments: a fundraising or technical milestone, press coverage, a market expansion, a sudden shift in the competitive environment. The startups that handle these well don't scramble reactively. |
| `two-kinds.closing` | Body (centered below table) | You need someone to build the GTM architecture and then show up fully ready. |
...
| `work.teradar.body` | Body | Teradar had terahertz sensing technology and deep silicon expertise. The founders wanted to raise a seed round. I worked with the CEO on their pitch deck and investor narrative, and did 1:1 communications coaching through 50+ meetings. The $2M+ seed round closed oversubscribed. That same foundation supported a Series A, a $150M Series B, and expanded to later technical product video engagements and CES launch assets. |
...
| `work.lux.body` | Body | Lux Labs was commercializing a transparent display film - with a proven technology and decent website traffic. But a 30-SKU catalog and spec-heavy data sheets slowed conversion. I reduced the catalog to two SKUs and mapped e-commerce flows to use cases instead of materials specs. We improved gross margins and simplified fulfillment. Pricing model remained in place through acquisition. |
...
|----------|-----|------|-------|
| `work.additional.01` | Pre-IPO investor roadshow | Investor roadshow video series for a private tech company preparing to file for IPO (S-1) - narrative strategy through video delivery with Opalite Media. The same narrative discipline for VCs also extends to public markets. | Investor strategy · Video production |
| `work.additional.02` | Connected-care devices (via Altitude) | User research and investment roadmapping for a global medical device manufacturer's physical fall-alert and aging-in-place line. Included in-home interviews, competitive audits, and adoption due diligence. | User research · M&A roadmapping |
| `work.additional.03` | Physical product research (via Altitude) | Usability research with industrial designers and mechanical engineers to inform design for a major consumer appliance OEM - evaluated in-kitchen food prep, cutting workflows, and product performance. | Usability testing · Market research |
...
| LOCATION | Type | Copy |
|----------|------|------|
| `contact.body.01` | Body | If your technology is genuine but the commercial story is still being figured out - that gap is solvable. But closing it earlier is usually worth more than closing it later. |
