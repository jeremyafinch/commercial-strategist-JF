...
| `work.preipo.descriptor` | Body | Investor video series for a company preparing to file an S-1 (IPO). |
...
| `work.reframe.descriptor` | Body | Unscripted founder conversation about AI prefab construction and robotics. |
...
| `work.akeneo.descriptor` | Body | An interactive maturity assessment and central B2B lead-gen asset. |
...
| `modal.lux.situation.body` | Body | Consulting project with an MIT transparent projection film startup. They had significant web traffic but weak conversion and low sales. A 30-SKU product line was too complex. Messaging led with technical specs instead of user language and B2B outcomes. |
| `modal.lux.outcome.label` | Label | Outcome |
| `modal.lux.outcome.body` | Body | Product line was simplified to two offerings (B2B and B2C paths). 100% ROI within 6 weeks through sales uplift and improved margins. Website and pricing structure held through acquisition. |
...
| `modal.akeneo.outcome.body` | Body | Built a key GTM tool that has run for 6+ years, generated tens of thousands of data points, and automated lead routing. Translated and localized into four languages. Still in use. |
